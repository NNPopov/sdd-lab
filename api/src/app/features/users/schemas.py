# FEATURE: users — vertical slice schemas.
# Expected change frequency: medium (new fields, validators).
from datetime import datetime
from typing import Annotated

from pydantic import BaseModel, ConfigDict, EmailStr, Field

from ...domain.shared.base_schemas import PersistentDeletion, TimestampSchema, UUIDSchema
