# FEATURE: get_user_tier — outside-in test fixtures.
...
@pytest_asyncio.fixture()
async def seeded_user_with_tier(async_client: AsyncClient):
    """Insert one Tier row and one User row referencing it through the overridden session."""
