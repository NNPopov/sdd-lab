# FEATURE: delete_user — outside-in test fixtures.
...
@pytest.fixture()
def alice_token() -> str:
    """A real, decodable JWT for 'alice' — passed as the Authorization Bearer token.

    Generated directly via jose.jwt so this fixture stays synchronous and fast.
    The token is valid for 30 minutes. The delete_user router passes it to
    TokenBlacklistService.blacklist() after the use-case succeeds.
    """
