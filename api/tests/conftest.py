...
# test_user.py has broken imports (src.app.schemas___.user, src.app.core.exceptions.*).
# Exclude it from collection so it doesn't interrupt the test session.
collect_ignore = ["test_user.py"]
...
def sample_user_read():
    ...
    from src.app.schemas___.user import UserRead
