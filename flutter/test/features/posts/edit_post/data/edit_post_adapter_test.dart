...
void main() {
  ...
  setUp(() {
    ...
    adapter = EditPostAdapter(api, logger);
  ...
  void mockApiSuccess() {
    when(() => api.patchPost(any(), any(), any())).thenAnswer((_) async {});
  }

  void mockApiThrows(Object error) {
    when(() => api.patchPost(any(), any(), any())).thenThrow(error);
  }
  ...
  group('call', () {
    ...
    test('DioException 500 → Left(ServerFailure)', () async {
      mockApiThrows(dioException(500));
