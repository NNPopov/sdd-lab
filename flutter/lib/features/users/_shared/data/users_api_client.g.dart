...
class _UsersApiClient implements UsersApiClient {
  ...
  Future<PaginatedUsersDto> getUsers({
    ...
    final _options = _setStreamType<PaginatedUsersDto>(
    ...
    late PaginatedUsersDto _value;
    try {
      _value = PaginatedUsersDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<UserDto> createUser(CreateUserRequestDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  Future<UserTierDto> getUserTier(String username) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserTierDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/${username}/tier',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserTierDto _value;
    try {
      _value = UserTierDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PaginatedTierOptionsDto> getTiersForSelection({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedTierOptionsDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tiers',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaginatedTierOptionsDto _value;
    try {
      _value = PaginatedTierOptionsDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
